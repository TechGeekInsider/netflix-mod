...
var observer = new MutationObserver(
    ...
    $(".slider-item").mouseover(function(){
        var show = $(this).find(".video-preload-title-label")[0].textContent;
        console.dir(show);
        var score = "Not Found";
        ...
        $(this).find(".bob-overlay").html("<div><h3>Rotten Tomatoe Score: " + score + "</h3></div>").css("position: absolute")
    })
    }
  );
observer.observe(document.getElementsByClassName('lolomo')[0], {childList:true});